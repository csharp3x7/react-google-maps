...
;(function() {
  ...
  this.OverlappingMarkerSpiderfier = (function() {
    ...
    c.markersNearAnyOtherMarker = function() {
      ...
      k = []
      a = d = 0
      for (b = g.length; d < b; a = ++d) {
        ;(c = g[a]), e[a].b && k.push(c)
      }
      return k
    }
    ...
    c.W = function(a, d) {
      ...
      g =
        r >= this.circleSpiralSwitchover ? this.M(r, b).reverse() : this.L(r, b)
      b = function() {
        var b, d, f
        f = []
        b = 0
