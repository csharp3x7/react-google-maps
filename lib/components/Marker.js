...
var Marker = (exports.Marker = (function(_React$PureComponent) {
  ...
  function Marker(props, context) {
    ...
    _this.props.onMarkerInitialized(marker)
    marker.id = _this.props.id
    marker.rank = _this.props.rank
    ...
    var overlappingSpiderfier = _this.context[_constants.OVERLAPPING_SPIDERFIER]
    if (markerClusterer) {
    ...
    },
    {
      ...
      value: function componentWillUnmount() {
        ...
        if (marker) {
          ...
          var overlappingSpiderfier = this.context[
...
Marker.propTypes = {
   ...
   * function
   */
  onMarkerInitialized: _propTypes2.default.func,
}
Marker.contextTypes =
